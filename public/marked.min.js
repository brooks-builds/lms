...
!(function (e, u) {
  ...
  function m(e, u, t, n) {
    ...
    return "!" !== e[0].charAt(0)
      ? ((n.state.inLink = !0),
        ...
        (n.state.inLink = !1),
        e)
      : { type: "image", raw: t, href: r, title: u, text: d(i) };
  }
  var b = (function () {
      function e(e) {
      ...
      return (
                ...
                null === (t = u.match(/^(\s+)(?:```)/))
                  ...
                  : ((r = t[1]),
                    n
                      ...
                      .map(function (e) {
                        var u = e.match(/^\s+/);
                        return null !== u && u[0].length >= r.length
                          ? e.slice(r.length)
                          : e;
                      })
                      .join("\n"))),
        ...
        (u.heading = function (e) {
          ...
          if (e)
            return (
              ...
              /#$/.test(u) &&
                ((t = E(u, "#")),
                (!this.options.pedantic && t && !/ $/.test(t)) ||
                  (u = t.trim())),
              {
                type: "heading",
                raw: e[0],
        ...
        (u.blockquote = function (e) {
          ...
          if (e)
            return (
              ...
              { type: "blockquote", raw: e[0], tokens: n, text: u }
            );
        }),
        (u.list = function (e) {
        ...
        (u.link = function (e) {
          ...
          if (e) {
            ...
            if (!this.options.pedantic && /^</.test(u)) {
              ...
              -1 < t &&
                ((r = (0 === e[0].indexOf("!") ? 5 : 4) + e[1].length + t),
                  ...
                  href:
                    (t = /^</.test(t)
                      ? this.options.pedantic && !/>$/.test(u)
                        ? t.slice(1)
                        : t.slice(1, -1)
                      : t) && t.replace(this.rules.inline._escapes, "$1"),
        ...
        (u.reflink = function (e, u) {
          ...
          if (
            ...
            return (e =
              u[(e = (t[2] || t[1]).replace(/\s+/g, " ")).toLowerCase()])
              ? m(t, e, t[0], this.lexer)
              : { type: "text", raw: (u = t[0].charAt(0)), text: u };
        }),
        (u.emStrong = function (e, u, t) {
          ...
          if (
            ...
            if (!r || "" === t || this.rules.inline.punctuation.exec(t)) {
              ...
              for (
                l.lastIndex = 0, u = u.slice(-1 * e.length + i);
                null != (n = l.exec(u));
        ...
        (u.autolink = function (e, u) {
          ...
          if (e)
            return (
              (u =
                "@" === e[2]
                  ? "mailto:" + (t = d(this.options.mangle ? u(e[1]) : e[1]))
                  : (t = d(e[1]))),
              {
                type: "link",
                raw: e[0],
              ...
              (u = this.lexer.state.inRawBlock
                ? this.options.sanitize
                  ? this.options.sanitizer
                    ...
                    : d(e[0])
                  : e[0]
                : d(this.options.smartypants ? u(e[0]) : e[0])),
  ...
  (w._uc_punctuation =
    ...
    (w.emStrong.rDelimUnd = h(w.emStrong.rDelimUnd, "g")
      .replace(/punct/g, w._punctuation)
      .getRegex()),
    (w.escapedPunct = h(w.escapedPunct, "g")
      .replace(/punct/g, w._punctuation)
      .getRegex()),
    (w._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
  ...
  var y = (function () {
      ...
      return (
              ...
              if (
                ...
                D.options.extensions &&
                  ...
                  D.options.extensions.startBlock.forEach(function (e) {
                    "number" == typeof (n = e.call({ lexer: this }, t)) &&
                      0 <= n &&
                      (u = Math.min(u, n));
                  }),
                  u < 1 / 0) &&
        ...
        (n.inlineTokens = function (r, i) {
          ...
          if (this.tokens.links) {
            ...
            if (0 < u.length)
              for (
                ...
                u.includes(e[0].slice(e[0].lastIndexOf("[") + 1, -1)) &&
                  (p =
                    p.slice(0, e.index) +
                    "[" +
          ...
          for (
            ;
            null != (e = this.tokenizer.rules.inline.escapedPunct.exec(p));

          )
            p =
              p.slice(0, e.index) +
              "++" +
              p.slice(this.tokenizer.rules.inline.escapedPunct.lastIndex);
          for (; r; ) {
            var t = (function () {
              if (
                (o || (D = ""),
        ...
        (u.code = function (e, u, t) {
          ...
          return (
            this.options.highlight &&
              null != (n = this.options.highlight(e, u)) &&
              n !== e &&
              ((t = !0), (e = n)),
            (e = e.replace(/\n$/, "") + "\n"),
            u
        ...
        (u.heading = function (e, u, t, n) {
          return this.options.headerIds
            ? "<h" +
                u +
                ' id="' +
                (this.options.headerPrefix + n.slug(t)) +
                '">' +
                e +
                "</h" +
                u +
                ...
                case "table":
                  for (a = D = "", r = o.header.length, t = 0; t < r; t++)
                    a += this.renderer.tablecell(
                      this.parseInline(o.header[t].tokens),
                      { header: !0, align: o.align[t] }
                    );
                  for (
          ...
          for (var t, n, r = "", i = e.length, s = 0; s < i; s++)
            if (
              ...
              this.options.extensions &&
                ...
                (!1 !==
                  (n = this.options.extensions.renderers[t.type].call(
                    { parser: this },
                    t
                  )) ||
                  ![
      ...
      u.forEach(function (s) {
              ...
              T.passThroughHooks.has(r)
                ? (o[r] = function (e) {
                    return I.defaults.async
                      ? Promise.resolve(s.hooks[r].call(o, e)).then(function (
                          e
                        ) {
                          return i.call(o, e);
                        })
        ...
        s.walkTokens &&
          ...
          (e.walkTokens = function (e) {
            var u = [];
            return (
              u.push(s.walkTokens.call(this, e)),
        ...
        !(function () {
          ...
          switch (((o = o.concat(a.call(I, u))), u.type)) {
            ...
            default:
              ...
              I.defaults.extensions.childTokens[u.type]
                ? I.defaults.extensions.childTokens[u.type].forEach(function (
                    e
                  ) {
